...
def test_generate_stylish():
    ...
    result_true_stylish = open("tests/fixtures/true_stylish").read()
...
def test_generate_plain():
    ...
    result_true_plain = open("tests/fixtures/true_plain").read()
...
def test_generate_json():
    ...
    result_true_json = open("tests/fixtures/true_json").read()
